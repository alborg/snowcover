 ...
 *
 * NOTES:
 * doy should be in the range 0-364.
 * 
 * RETURN VALUES:
...
double fmesd(int doy) {
    ...
    theta0 = (2.*fmPI*doy)/365.0; /* in radians */
...
double fmsolarzenith(fmsec1970 tst, fmgeopos gpos) {
    ...
    tsthour += (gpos.lon*0.0667); /* longitude correction of time */
    tsthour += et; /* Equation of time correction */
