 ...
 * Øystein Godøy, met.no/FOU, 23.03.2004
 * Changed satellite name check to avoid software stopping when processing
 * unknown satellites. Only first image of multiimage files is presented.
...
int fm_MITIFF_fillhead_imagepal(char *asciifield, char *tag, fmio_mihead_pal *palinfo) {
    ...
    int i;
    char *pt;
    char *where="MITIFF fillhead_imagepal";
