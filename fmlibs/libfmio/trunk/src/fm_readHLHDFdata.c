 ...
 *
 * PURPOSE:
 * To read HDF5 (HLHDF) files containing data generated by the CMSAF.
 * These files contain AVHRR, observation geometry and PPS products.
 * Everything is stored in HLHDF so this function should do some thorough
 * checking of contents and then read whatever is found. Actually, it
 * should work for most HLHDF files whether from CM or NWC SAFs.
 *
 * REQUIREMENTS:
 * NA
 *
 ...
 *
 * NOTES:
 * In PPS files all data (cloudtype, region, ...) are located in the root
 * group. For AVHRR and observation files, data have several groups, like
 * how, what, where and image.
 *
 * Rewrite code to utilise functions like the string retrieval algorithm.
 *
 * BUGS:
 * NA
 *
 ...
 *
 * MODIFIED:
 * Øystein Godøy, METNO/FOU, 2011-11-11: Adding extraction of header data.
 * Øystein Godøy, METNO/FOU, 2011-11-14: Adding extraction of image data.
 * Øystein Godøy, METNO/FOU, 2011-11-15: Reading of image data as well as
 * positions are included.
 * Øystein Godøy, METNO/FOU, 2011-11-15: First version that reads both
 * AVHRR and geometry files.
 * Øystein Godøy, METNO/FOU, 2011-12-19: First version that reads PPS
 * products. However, CMSAF PPS products have several insufficiencies that
 * are not handled.
 * Øystein Godøy, METNO/FOU, 2012-05-04: Removed orfant memory allocation.
 * Hanne Heiberg, MET/FOU, 2013-05-31: Add reading of cloudmask file.
 * Øystein Godøy, METNO/FOU, 2013-06-28: Minor modifications concerning CT
 * quality and test flag extraction.
 *
 * ID:
 * $Id$
 */
