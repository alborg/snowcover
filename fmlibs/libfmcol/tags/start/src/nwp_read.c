...
int nwpdata_read(char *filenames, fmtime reqtime, struct ucs refucs, 
    ...
    */
    ...
    static char feltfilepresl[FFNS][30] = { 
	    "/opdata/hirlam20/grdn00.dat-1", 
	    "/opdata/hirlam20/grdn06.dat-1", 
	    "/opdata/hirlam20/grdn12.dat-1", 
	    "/opdata/hirlam20/grdn18.dat-1" 
    };
    /* Files to access NWP data at model lev*/
    static char feltfilemodl[FFNS][31] = { 
	    "/opdata/hirlam20/grdnm00.dat-1", 
	    "/opdata/hirlam20/grdnm06.dat-1", 
	    "/opdata/hirlam20/grdnm12.dat-1", 
	    "/opdata/hirlam20/grdnm18.dat-1" 
    };
    /*
    ...
    */
    ...
    int iparam2[NOFIELDS2][4]={ /* Spec of what to get */
    ...
    */
    ...
    if (ierror) {
	errmsg(where,"error reading surface and parameter fields");
	return(2);
    }
