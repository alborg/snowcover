 ...
 *
 * AUTHOR:
 * �ystein God�y, DNMI/FoU, 26/11/2000.
 *
 * MODIFIED:
 * �ystein God�y, met.no/FOU, 27.09.2004
 * Modification for full Bayes approach started...
 * �ystein God�y, met.no/FOU, 03.11.2004: See pix_proc.c
 * �ystein God�y, METNO/FOU, 30.10.2006: See pap_avhrrice.c
 * �ystein God�y, METNO/FOU, 11.01.2007: Changed some names, added missing
 * 3A code
 * �ystein God�y, METNO/FOU, 02.04.2007: Added 3B support.
