 ...
 *
 * MODIFIED:
 * �ystein God�y, met.no/FOU, 18.11.2004: Adapted for Ch3a and normal
 * distribution...
 * �ystein God�y, METNO/FOU, 30.10.2006: Added the function Hanne Heiberg
 * have been using as probest_hanneh, changed function interface.
 * �ystein God�y, METNO/FOU, 11.01.2007: Changed some names.
